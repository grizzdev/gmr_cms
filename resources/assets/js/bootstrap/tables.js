...
(function ($) {
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        if (this.options.queryParamsType === 'limit') {
        ...
        } else if (this.options.queryParamsType == 'laravel') {
            params = {
                search: params.searchText,
                sort: params.sortName,
                order: params.sortOrder,
            ...
            if (this.options.pagination) {
                params.take = (this.options.pageSize === this.options.formatAllRows()) ? this.options.totalRows : this.options.pageSize;
                params.skip = (this.options.pageSize === this.options.formatAllRows()) ? 0 : this.options.pageSize * (this.options.pageNumber - 1);
                params.page = this.options.pageNumber;
                params.per_page = this.options.pageSize;
            }
        }
    ...
    BootstrapTable.prototype.load = function (data) {
        ...
        if (this.options.sidePagination === 'server') {
            ...
            if (this.options.queryParamsType == 'laravel') {
                data = data.data;
            } else {
                data = data.rows;
            }
