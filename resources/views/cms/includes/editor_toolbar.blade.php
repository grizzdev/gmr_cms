<div class="btn-toolbar" data-role="editor-toolbar" data-target="#{!! $target !!}">
	<div class="btn-group">
	...
	<div class="btn-group">
		...
		<!--<a class="btn btn-primary" data-edit="strikethrough" title="" data-original-title="Strikethrough"><i class="icon-strikethrough"></i></a>-->
		<!--<a class="btn btn-primary" data-edit="underline" title="" data-original-title="Underline (Ctrl/Cmd+U)"><i class="icon-underline"></i></a>-->
	</div>
	<div class="btn-group">
		...
		<a class="btn btn-primary" data-edit="outdent" title="" data-original-title="Reduce indent (Shift+Tab)"><i class="glyphicon glyphicon-indent-right"></i></a>
		<a class="btn btn-primary" data-edit="indent" title="" data-original-title="Indent (Tab)"><i class="glyphicon glyphicon-indent-left"></i></a>
	</div>
	<div class="btn-group">
	...
	<div class="btn-group">
		...
		<a class="btn btn-primary" data-edit="unlink" title="" data-original-title="Remove Hyperlink"><i class="glyphicon glyphicon-scissors"></i></a>
	</div>
	<div class="btn-group">
	...
	<div class="btn-group">
		<a class="btn btn-primary" data-edit="undo" title="" data-original-title="Undo (Ctrl/Cmd+Z)"><i class="glyphicon glyphicon-undo"></i></a>
		<a class="btn btn-primary" data-edit="redo" title="" data-original-title="Redo (Ctrl/Cmd+Y)"><i class="glyphicon glyphicon-repeat"></i></a>
	</div>
</div>
