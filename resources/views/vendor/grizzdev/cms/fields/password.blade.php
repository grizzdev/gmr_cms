<div class="col-xs-12 col-sm-6">
	<div class="form-group {!! ($data['required']) ? 'has-feedback' : '' !!}">
		...
		<div class="input-group">
			{!! Form::$data['type']($field, ['class' => 'form-control', $data['required'], $data['disabled']]) !!}
...
<div class="col-xs-12 col-sm-6">
	<div class="form-group {!! ($data['required']) ? 'has-feedback' : '' !!}">
		...
		<div class="input-group">
			{!! Form::$data['type']($field.'_confirmation', ['class' => 'form-control', 'data-match' => "#$field", $data['required'], $data['disabled']]) !!}
			<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
		</div>
	</div>
</div>
